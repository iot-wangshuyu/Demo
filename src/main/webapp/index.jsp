...
<script type="text/javascript" src="<%=basePath%>resource/jquery-1.11.0.min.js"></script>
<style type="text/css">
.h1 {
	margin: 0 auto;
}
...
<body>
	...
	<div id="producer">
		...
		<br>
		<button onclick="send('queue/user')">发送Queue消息</button>
		<button onclick="send('topic/user')">发送Topic消息</button>
		<br>
		<span id="status"></span>
	</div>
</body>
